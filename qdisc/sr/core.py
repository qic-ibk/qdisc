...
# %% auto #0
__all__ = ['EPS', 'pearson_between_vectors_vmap', 'spearman_rho_vmap', 'TwoBodyModel', 'FFNN_theta_to_mu', 'class_loss',
...
# %% ../../nbs/lib_nbs/sr/01_core.ipynb #6163724a
...
# %% ../../nbs/lib_nbs/sr/01_core.ipynb #7aee8db9
def curved_edge(ax, x1, y1, x2, y2, curvature=0.2, **plot_kwargs):
    """
        Draw a curved (quadratic Bézier) edge between (x1,y1) and (x2,y2).
        curvature > 0 bends left, curvature < 0 bends right. Used to visualize pairwise interactions in the 2BC.
    """
